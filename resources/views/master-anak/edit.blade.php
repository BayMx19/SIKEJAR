                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_anak" required
                                                    autocomplete="off" value="{{$anak->nama_anak}}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select" name="users_id">
                                                    ...
                                                    <option value="{{ $item->id }}"
                                                        {{ $item->id == $anak->users_id ? 'selected' : '' }}>
                                                        {{ $item->nama }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" name="tanggal_lahir_anak"
                                                    autocomplete="off" value="{{$anak->tanggal_lahir_anak}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-select" name="jenis_kelamin">
                                                    ...
                                                    <option value="L"
                                                        {{ $anak->jenis_kelamin == 'L' ? 'selected' : '' }}>Laki - Laki
                                                    </option>
                                                    <option value="P"
                                                        {{ $anak->jenis_kelamin == 'P' ? 'selected' : '' }}>Perempuan
                                                    </option>
                                                </select>
