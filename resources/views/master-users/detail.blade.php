...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Detail Users </h3>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="NIK" minlength="16"
                                                    maxlength="16" autocomplete="off" value="{{$user->NIK}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="alamat" class="form-control" name="alamat"
                                                    value="{{$user->alamat}}" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- RT -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="alamat" class="form-control" name="RT"
                                                    value="{{$user->RT}}" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="alamat" class="form-control" name="RW"
                                                    value="{{$user->RW}}" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Nomor Telepon -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" name="nomor_telepon"
                                                    autocomplete="off" value="{{$user->nomor_telepon}}" readonly>
                                            </div>
                                        </div>
                                    </div>
